...
class opComp():
    def __init__(self, memory, inp = None):
        if inp:
            self.input_l = [inp]
        self.memory = memory[:]
    ...
    def opCode3(self, modes = None):
        ...
        self.set_param(modes[2], self.instPoint+1, inp)
        self.instPoint += 2
    # -----------------------------------------------------------------------------------------------------------------------
